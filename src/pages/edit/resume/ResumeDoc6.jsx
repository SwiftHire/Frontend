...
import emailIcon from '../../../assets/png/email-yellow.png';
import phoneIcon from '../../../assets/png/phone-yellow.png';
import locationIcon from '../../../assets/png/location-yellow.png';
import linkedinIcon from '../../../assets/png/linkedin-yellow.png';
    ...
    <Document>
      <Page size="A3" style={styles.page}>
        <View>
            ...
            <Text style={[styles.headerText, { color:'#F86500'}]}>{ data?.position }</Text>
        </View>
        <View style={styles.iconsContainer}>
        {data?.country && <Image src={locationIcon} alt="" style={{ width: '13px', height: '13px'}} />} {data?.country && <Text style={styles.iconText}>{data.city}, {data.country} </Text>}
            ...
            {data?.workExperience && data?.workExperience?.map((experience, index)=>(
              <View  style={styles.sectionInner}>
                ...
                <View  style={{ flexBasis:62 + '%', marginTop:15 }}>
                    ...
                    <Text style={{ fontSize: 15, color:'#F86500'}}>{experience.company !== undefined ? experience?.company : ''}</Text>
      ...
      {data?.skill?.length > 0 && <View>?
        ...
        <View style={{flexDirection:'row'}}>
          {data?.skill.map((skill)=>(
            <Text style={[styles.text, {borderBottom:2, borderColor:'#dcd5ff', margin:3, paddingTop:2, paddingLeft:5, paddingRight:5}]}>
              { skill.skill }
            </Text>
          ))}
        </View>
